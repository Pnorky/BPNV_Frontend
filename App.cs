...
public class App : Application
{
    ...
    private void ConfigureDataTemplates()
    {
        ...
        DataTemplates.Add(new FuncDataTemplate<CashierSalesViewModel>((_, _) => new CashierSalesView(), true));
        ...
        DataTemplates.Add(new FuncDataTemplate<EmployeeBalancesViewModel>((_, _) => new EmployeeBalancesView(), true));
